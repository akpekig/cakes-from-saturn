...
export default function Case({ caseColor = "LIGHT" }: CaseProps) {
    return (
        <g id="case">
            <path className={`paper-${caseColor.toLowerCase()}`} d="m100 380.7h520.4l-84.8 229.5c0 17.5-350.8 17.5-350.8 0z"/>
            <path className="paper-outline" d="m113 386.8h494.4l-80.5 218c0 16.7-333.3 16.7-333.3 0z"/>
            <path className="paper-shadow" d="m113 386.8h494.4l-80.5 218c0 16.7-333.3 16.7-333.3 0z"/>
